<template>
  <!-- nav bar -->
  <div class="nav-bar-container flex-container">
    <!-- logo -->
    ...
    <nav class="nav-bar">
      <ul class="flex-container">
        <li>
          <router-link to="/" class="active-nav">Home</router-link>
        </li>
        <li>
    ...
    <div class="humburger-container" @click="handleToggle">
